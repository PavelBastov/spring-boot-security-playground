 ...
 *
 * The {@link SecurityFilterChain} bean replaces the old WebSecurityConfigurerAdapter
 * (removed back in Spring Security 6). Everything is configured with the lambda DSL.
 */
@Configuration
public class SecurityConfig {
	...
	/**
	 * Two in-memory users so you can immediately try role-based access.
	 * Swap this out for a JdbcUserDetailsManager or a custom UserDetailsService
	 * once you want to play with persistence.
	 */
	@Bean
